...
class ChApiModal ChModalSolver {
  public:
    ...
    ChModalSolver(int n_lower_modes,  ///< n of lower modes
                  ...
                  bool clip_position_coords,
                  bool scaleCq,
                  bool verbose)
        : m_freq_spans({{n_lower_modes, base_freq}}),
          m_clip_position_coords(clip_position_coords),
          m_scaleCq(scaleCq),
          m_verbose(verbose){};
    ...
    ChModalSolver(std::vector<ChFreqSpan> freq_spans, bool clip_position_coords, bool scaleCq, bool verbose)
        : m_freq_spans(freq_spans),
          m_clip_position_coords(clip_position_coords),
          m_scaleCq(scaleCq),
          m_verbose(verbose){};
