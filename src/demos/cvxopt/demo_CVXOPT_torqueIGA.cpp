...
int main(int argc, char* argv[]) {
    ...
    const double bundle_radius = 0.1;
    ...
    auto mFlangeStart = std::make_shared<ChBodyEasyCylinder>(bundle_radius*1.1, flange_thickness, 1000, false, true, ChMaterialSurface::NSC);
    ...
    auto mFlangeEnd = std::make_shared<ChBodyEasyCylinder>(bundle_radius*1.1, flange_thickness, 1000, false, true, ChMaterialSurface::NSC);
    ...
    auto mFlangeEndFixed = std::make_shared<ChBodyEasyBox>(2.5*bundle_radius, 2.5*bundle_radius, flange_thickness, 1000, false, true);
    ...
    rotMot->SetAngleOffset(30.0*CH_C_DEG_TO_RAD);
    ...
    ChIrrApp application(&my_system, L"Torquing IGA beams", core::dimension2d<u32>(800, 600),
        false, true);
