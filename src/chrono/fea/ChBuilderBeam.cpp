...
void ChExtruderBeamEuler::SetContact(std::shared_ptr<ChMaterialSurface> mcontact_material, double mcontact_radius) {
...
void ChExtruderBeamIGA::SetContact(std::shared_ptr<ChMaterialSurface> mcontact_material, double mcontact_radius) {
    this->contact_material = mcontact_material;
    this->contact_radius = mcontact_radius;
    this->contactcloud = std::make_shared<ChContactSurfaceNodeCloud>();
    this->mesh->AddContactSurface(contactcloud);
